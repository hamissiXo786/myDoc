...
import 'view_patients_model.dart';
export 'view_patients_model.dart';

class ViewPatientsWidget extends StatefulWidget {
  const ViewPatientsWidget({super.key});

  @override
  State<ViewPatientsWidget> createState() => _ViewPatientsWidgetState();
}

class _ViewPatientsWidgetState extends State<ViewPatientsWidget> {
  late ViewPatientsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewPatientsModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 45.0, 20.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                StreamBuilder<List<PatientsRecord>>(
                                  stream: queryPatientsRecord(
                                    queryBuilder: (patientsRecord) =>
                                        patientsRecord.orderBy('created_at',
                                            descending: true),
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewPatientsRecordList.length,
