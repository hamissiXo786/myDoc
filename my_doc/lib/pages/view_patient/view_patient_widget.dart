...
import '/pages/picture/picture_widget.dart';
import 'package:flutter/material.dart';
import 'view_patient_model.dart';
export 'view_patient_model.dart';

class ViewPatientWidget extends StatefulWidget {
  const ViewPatientWidget({
    super.key,
  ...
  @override
  State<ViewPatientWidget> createState() => _ViewPatientWidgetState();
}

class _ViewPatientWidgetState extends State<ViewPatientWidget> {
  late ViewPatientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewPatientModel());
